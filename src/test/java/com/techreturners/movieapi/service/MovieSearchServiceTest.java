...
public class MovieSearchServiceTest {
    ...
    public void testSearchMethodIsCalled() throws Exception{
        ...
        String testURI=
                "https://api.themoviedb.org/3/discover/movie?api_key=70cb6bbe42e70d00630d60e98da21a75&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&with_watch_monetization_types=flatrate";
